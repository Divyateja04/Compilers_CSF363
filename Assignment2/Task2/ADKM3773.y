...
FOR_EXPRESSION_LIST: FOR_TERM
| FOR_EXPRESSION_LIST PLUS FOR_EXPRESSION_LIST
| FOR_EXPRESSION_LIST MINUS FOR_EXPRESSION_LIST
| FOR_EXPRESSION_LIST MULTIPLY FOR_EXPRESSION_LIST
| FOR_EXPRESSION_LIST DIVIDE FOR_EXPRESSION_LIST
| FOR_EXPRESSION_LIST MOD FOR_EXPRESSION_LIST
| LPAREN FOR_EXPRESSION_LIST RPAREN

FOR_TERM: IDENTIFIER
| IDENTIFIER ARRAY_ADD_ON_ID
| NUMBER

FOR_LOOP_TO: FOR IDENTIFIER COLON EQUAL FOR_EXPRESSION_LIST TO FOR_EXPRESSION_LIST DO BODY_OF_LOOP SEMICOLON
;

FOR_LOOP_DOWNTO: FOR IDENTIFIER COLON EQUAL FOR_EXPRESSION_LIST DOWNTO FOR_EXPRESSION_LIST DO BODY_OF_LOOP SEMICOLON
;
