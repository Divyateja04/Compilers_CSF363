...
%token PROGRAM INTEGER REAL BEGINK END BOOLEAN CHAR IF ELSE TO DOWNTO VAR ARRAY FOR WHILE DO NOT AND OR READ WRITE
...
PROGRAMSTRUCT: PROGRAM IDENTIFIER SEMICOLON
;
...
MULTIVAR: VARIABLELIST COLON DATATYPE SEMICOLON | ARRAYDEF
;
...
WRITE_STATEMENT: WRITE LPAREN IDENTIFIER RPAREN SEMICOLON | WRITE LPAREN STRING RPAREN SEMICOLON
;

ASSIGNMENT_STATEMENT: IDENTIFIER COLON EQUAL EXPRESSION SEMICOLON
;
...
WHILEDO: WHILE LPAREN CONDITION RPAREN DO BLOCK_STATEMENT
;
